...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands = [
    ...
    { id: 'linkedin', title: 'Connect on LinkedIn', category: 'External Links', icon: ExternalLink, action: () => window.open('https://linkedin.com/in/sharanghrav-j-970b63362', '_blank') },
